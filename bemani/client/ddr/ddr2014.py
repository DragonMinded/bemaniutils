...
class DDR2014Client(BaseClient):
    ...
    def verify_game_common(self) -> None:
        ...
        self.assert_path(resp, "response/game/cnt_music_monthly")
        self.assert_path(resp, "response/game/cnt_music_weekly")
        self.assert_path(resp, "response/game/cnt_music_daily")
    ...
    def verify_game_load(self, ref_id: str, msg_type: str) -> Dict[str, Any]:
        ...
        if msg_type == "existing":
            ...
            self.assert_path(resp, "response/game/option_ver/@ver")
            self.assert_path(resp, "response/game/flag")
            self.assert_path(resp, "response/game/flag_ex")
