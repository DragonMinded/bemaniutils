...
class IIDXSpadaClient(BaseClient):
    ...
    def verify_iidx21pc_common(self) -> None:
        call = self.call_node()
        ...
        self.assert_path(resp, "response/IIDX21pc/limit/@phase")
        self.assert_path(resp, "response/IIDX21pc/boss/@phase")
        self.assert_path(resp, "response/IIDX21pc/boss1/@phase")
        self.assert_path(resp, "response/IIDX21pc/medal/@phase")
        self.assert_path(resp, "response/IIDX21pc/tricolettepark_skip/@phase")
        self.assert_path(resp, "response/IIDX21pc/superstar/@phase")
        self.assert_path(resp, "response/IIDX21pc/tricolettepark/@open")
        self.assert_path(resp, "response/IIDX21pc/cafe/@open")
        self.assert_path(resp, "response/IIDX21pc/newsong_another/@open")
        self.assert_path(resp, "response/IIDX21pc/vip_pass_black")

    def verify_iidx21music_crate(self) -> None:
        call = self.call_node()
    ...
    def verify_iidx21shop_getconvention(self, lid: str) -> None:
        ...
        self.assert_path(resp, "response/IIDX21shop/@music_0")
        self.assert_path(resp, "response/IIDX21shop/@music_1")
        self.assert_path(resp, "response/IIDX21shop/@music_2")
        self.assert_path(resp, "response/IIDX21shop/@music_3")

    def verify_iidx21pc_visit(self, extid: int, lid: str) -> None:
        call = self.call_node()
        ...
        self.assert_path(resp, "response/IIDX21pc/@anum")
        self.assert_path(resp, "response/IIDX21pc/@pflg")
        self.assert_path(resp, "response/IIDX21pc/@pnum")
        self.assert_path(resp, "response/IIDX21pc/@sflg")
        self.assert_path(resp, "response/IIDX21pc/@snum")

    def verify_iidx21ranking_getranker(self, lid: str) -> None:
    ...
    def verify_iidx21shop_sentinfo(self, lid: str) -> None:
        call = self.call_node()
    ...
    def verify_iidx21pc_get(
        ...
        self.assert_path(resp, "response/IIDX21pc/pcdata/@pid")
        self.assert_path(resp, "response/IIDX21pc/pcdata/@id")
        self.assert_path(resp, "response/IIDX21pc/pcdata/@idstr")
        self.assert_path(resp, "response/IIDX21pc/packinfo")
        self.assert_path(resp, "response/IIDX21pc/deller")
        self.assert_path(resp, "response/IIDX21pc/secret/flg1")
        self.assert_path(resp, "response/IIDX21pc/secret/flg2")
        self.assert_path(resp, "response/IIDX21pc/secret/flg3")
        self.assert_path(resp, "response/IIDX21pc/achievements/trophy")
        self.assert_path(resp, "response/IIDX21pc/skin")
        self.assert_path(resp, "response/IIDX21pc/grade")
        self.assert_path(resp, "response/IIDX21pc/rlist")
        self.assert_path(resp, "response/IIDX21pc/step/album")
        self.assert_path(resp, "response/IIDX21pc/favorite/sp_mlist")
        self.assert_path(resp, "response/IIDX21pc/favorite/sp_clist")
    ...
    def verify_iidx21pc_save(self, extid: int, card: str, lid: str) -> None:
        call = self.call_node()
    ...
    def verify_iidx21music_play(self, score: Dict[str, int]) -> None:
        call = self.call_node()
        ...
        self.assert_path(resp, "response/IIDX21music/@crate")
        self.assert_path(resp, "response/IIDX21music/@frate")
        self.assert_path(resp, "response/IIDX21music/@mid")

    def verify_iidx21pc_playend(self) -> None:
        call = self.call_node()
    ...
    def verify_iidx21music_breg(self, iidxid: int, score: Dict[str, int]) -> None:
        call = self.call_node()
    ...
    def verify(self, cardid: Optional[str]) -> None:
        ...
        self.verify_iidx21shop_getname(lid)
        self.verify_iidx21pc_common()
        self.verify_iidx21music_crate()
        self.verify_iidx21shop_getconvention(lid)
        self.verify_iidx21ranking_getranker(lid)
        self.verify_iidx21shop_sentinfo(lid)
