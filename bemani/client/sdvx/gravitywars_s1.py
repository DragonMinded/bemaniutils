...
class SoundVoltexGravityWarsS1Client(BaseClient):
    NAME = "TEST"
    ...
    def verify_game_hiscore(self, location: str) -> None:
        ...
        self.assert_path(resp, "response/game_3/hiscore_allover/info/code")
        ...
        self.assert_path(resp, "response/game_3/hiscore_location/info/code")
