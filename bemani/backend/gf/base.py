...
class GuitarFreaksBase(CoreHandler, CardManagerHandler, Base):
    """
    Trying to work on GFDM right now. now it's time to play the guitar rhythmically :)
    """

    game = GameConstants.GUITARFREAKS


    CHART_TYPE_GUITAR_BEGINNER = 0
    CHART_TYPE_GUITAR_BASIC = 1
    CHART_TYPE_GUITAR_ADVANCED = 2
    CHART_TYPE_GUITAR_EXTREME = 3
    CHART_TYPE_BASS_BEGINNER = 4
    CHART_TYPE_BASS_BASIC = 5
    CHART_TYPE_BASS_ADVANCED = 6
    CHART_TYPE_BASS_EXTREME = 7
    CHART_TYPE_OPEN_BEGINNER = 8
    CHART_TYPE_OPEN_BASIC = 9
    CHART_TYPE_OPEN_ADVANCED = 10
    CHART_TYPE_OPEN_EXTREME = 11
