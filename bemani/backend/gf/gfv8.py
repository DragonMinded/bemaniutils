...
class GuitarFreaksV8(
    ...
    name = "GuitarFreaks V8"
    version = VersionConstants.GUITARFREAKS_V8
    ...
    GAME_CHART_TYPE_GUITAR_BEGINNER = 0
    GAME_CHART_TYPE_GUITAR_BASIC = 1
    GAME_CHART_TYPE_GUITAR_ADVANCED = 2
    GAME_CHART_TYPE_GUITAR_EXTREME = 3
    GAME_CHART_TYPE_BASS_BEGINNER = 4
    GAME_CHART_TYPE_BASS_BASIC = 5
    GAME_CHART_TYPE_BASS_ADVANCED = 6
    GAME_CHART_TYPE_BASS_EXTREME = 7
    GAME_CHART_TYPE_OPEN_BEGINNER = 8
    GAME_CHART_TYPE_OPEN_BASIC = 9
    GAME_CHART_TYPE_OPEN_ADVANCED = 10
    GAME_CHART_TYPE_OPEN_EXTREME = 11
    ...
    def previous_version(self) -> Optional[GuitarFreaksBase]:
        return GuitarFreaksV7(self.data, self.config, self.model)

    def db_to_game_chart(self, db_chart: int) -> int:
        return {
            self.CHART_TYPE_GUITAR_BEGINNER: self.GAME_CHART_TYPE_GUITAR_BEGINNER,
            self.CHART_TYPE_GUITAR_BASIC: self.GAME_CHART_TYPE_GUITAR_BASIC,
            self.CHART_TYPE_GUITAR_ADVANCED: self.GAME_CHART_TYPE_GUITAR_ADVANCED,
            self.CHART_TYPE_GUITAR_EXTREME: self.GAME_CHART_TYPE_GUITAR_EXTREME,
            self.CHART_TYPE_BASS_BEGINNER: self.GAME_CHART_TYPE_BASS_BEGINNER,
            self.CHART_TYPE_BASS_BASIC: self.GAME_CHART_TYPE_BASS_BASIC,
            self.CHART_TYPE_BASS_ADVANCED: self.GAME_CHART_TYPE_BASS_ADVANCED,
            self.CHART_TYPE_BASS_EXTREME: self.GAME_CHART_TYPE_BASS_EXTREME,
            self.CHART_TYPE_OPEN_BEGINNER: self.GAME_CHART_TYPE_OPEN_BEGINNER,
            self.CHART_TYPE_OPEN_BASIC: self.GAME_CHART_TYPE_OPEN_BASIC,
            self.CHART_TYPE_OPEN_ADVANCED: self.GAME_CHART_TYPE_OPEN_ADVANCED,
            self.CHART_TYPE_OPEN_EXTREME: self.GAME_CHART_TYPE_OPEN_EXTREME,
        }[db_chart]
    ...
    def handle_gameinfo_get_request(self, request: Node) -> Node:
        ...
        quest.add_child(Node.u8('division', 0))
        quest.add_child(Node.u8('border', 0))
    ...
    def handle_cardutil_check_request(self, request: Node) -> Node:
        ...
        cardret.set_attribute('no', playernum)
    ...
    def handle_gametop_get_request(self, request: Node) -> Node:
        ...
        playernum = playergt.attribute('no')
        ...
        player.set_attribute('no', playernum)
    ...
    def handle_gametop_get_rival_request(self, request: Node) -> Node:
        ...
        getplayer = request.child('player')
        playernum = getplayer.attribute('no')

        playerrefid = getplayer.child_value('refid')
        myrivalid = getplayer.child_value('rivalid')
    ...
    def format_scores(self, userid: UserID, profile: ValidatedDict, scores: List[Score]) -> Node:
        ...
        for key in combined_scores:
            ...
            bass_bsc_data = ValidatedDict()
            bass_adv_data = ValidatedDict()
            bass_ext_data = ValidatedDict()
            open_bsc_data = ValidatedDict()
            open_adv_data = ValidatedDict()
            open_ext_data = ValidatedDict()
            ...
            if bass_basic in scores:
                bass_bsc_data = ValidatedDict(scores[bass_basic].data)
            if bass_advanced in scores:
                bass_adv_data = ValidatedDict(scores[bass_advanced].data)
            if bass_extreme in scores:
                bass_ext_data = ValidatedDict(scores[bass_extreme].data)

            if open_basic in scores:
                open_bsc_data = ValidatedDict(scores[open_basic].data)
            if open_advanced in scores:
                open_adv_data = ValidatedDict(scores[open_advanced].data)
            if open_extreme in scores:
                open_ext_data = ValidatedDict(scores[open_extreme].data)
            ...
            # bass_Basic
            bass_bsc_clear = bass_bsc_data.get_int('clear', 0)
            bass_bsc_fullcombo = bass_bsc_data.get_int('fullcombo', 0)
            bass_bsc_excellent = bass_bsc_data.get_int('excellent', 0)
            bass_bsc_skill_points = bass_bsc_data.get_int('skill_points', 0)
            bass_bsc_skill_perc = bass_bsc_data.get_int('skill_perc', -2)
            bass_bsc_result_rank = bass_bsc_data.get_int('result_rank', -2)
            bass_bsc_combo_rate = bass_bsc_data.get_int('combo_rate', 0)
            bass_bsc_perfect_rate = bass_bsc_data.get_int('perfect_rate', 0)

            # bass_Advanced
            bass_adv_clear = bass_adv_data.get_int('clear', 0)
            bass_adv_fullcombo = bass_adv_data.get_int('fullcombo', 0)
            bass_adv_excellent = bass_adv_data.get_int('excellent', 0)
            bass_adv_skill_points = bass_adv_data.get_int('skill_points', 0)
            bass_adv_skill_perc = bass_adv_data.get_int('skill_perc', -2)
            bass_adv_result_rank = bass_adv_data.get_int('result_rank', -2)
            bass_adv_combo_rate = bass_adv_data.get_int('combo_rate', 0)
            bass_adv_perfect_rate = bass_adv_data.get_int('perfect_rate', 0)

            # bass_Extreme
            bass_ext_clear = bass_ext_data.get_int('clear', 0)
            bass_ext_fullcombo = bass_ext_data.get_int('fullcombo', 0)
            bass_ext_excellent = bass_ext_data.get_int('excellent', 0)
            bass_ext_skill_points = bass_ext_data.get_int('skill_points', 0)
            bass_ext_skill_perc = bass_ext_data.get_int('skill_perc', -2)
            bass_ext_result_rank = bass_ext_data.get_int('result_rank', -2)
            bass_ext_combo_rate = bass_ext_data.get_int('combo_rate', 0)
            bass_ext_perfect_rate = bass_ext_data.get_int('perfect_rate', 0)

            # open_Basic
            open_bsc_clear = open_bsc_data.get_int('clear', 0)
            open_bsc_fullcombo = open_bsc_data.get_int('fullcombo', 0)
            open_bsc_excellent = open_bsc_data.get_int('excellent', 0)
            open_bsc_skill_points = open_bsc_data.get_int('skill_points', 0)
            open_bsc_skill_perc = open_bsc_data.get_int('skill_perc', -2)
            open_bsc_result_rank = open_bsc_data.get_int('result_rank', -2)
            open_bsc_combo_rate = open_bsc_data.get_int('combo_rate', 0)
            open_bsc_perfect_rate = open_bsc_data.get_int('perfect_rate', 0)

            # open_Advanced
            open_adv_clear = open_adv_data.get_int('clear', 0)
            open_adv_fullcombo = open_adv_data.get_int('fullcombo', 0)
            open_adv_excellent = open_adv_data.get_int('excellent', 0)
            open_adv_skill_points = open_adv_data.get_int('skill_points', 0)
            open_adv_skill_perc = open_adv_data.get_int('skill_perc', -2)
            open_adv_result_rank = open_adv_data.get_int('result_rank', -2)
            open_adv_combo_rate = open_adv_data.get_int('combo_rate', 0)
            open_adv_perfect_rate = open_adv_data.get_int('perfect_rate', 0)

            # open_Extreme
            open_ext_clear = open_ext_data.get_int('clear', 0)
            open_ext_fullcombo = open_ext_data.get_int('fullcombo', 0)
            open_ext_excellent = open_ext_data.get_int('excellent', 0)
            open_ext_skill_points = open_ext_data.get_int('skill_points', 0)
            open_ext_skill_perc = open_ext_data.get_int('skill_perc', -2)
            open_ext_result_rank = open_ext_data.get_int('result_rank', -2)
            open_ext_combo_rate = open_ext_data.get_int('combo_rate', 0)
            open_ext_perfect_rate = open_ext_data.get_int('perfect_rate', 0)



            cleared = -1
            if bsc_clear == 1 or adv_clear == 1 or ext_clear == 1 or bass_bsc_clear == 1 or bass_adv_clear == 1 or bass_ext_clear == 1 or open_bsc_clear == 1 or open_adv_clear == 1 or open_ext_clear == 1:
                cleared = 0
            ...
            elif bass_bsc_skill_points != 0:
                load_skill_points = bass_bsc_skill_points
            elif bass_adv_skill_points != 0:
                load_skill_points = bass_adv_skill_points
            elif bass_ext_skill_points != 0:
                load_skill_points = bass_ext_skill_points
            elif open_bsc_skill_points != 0:
                load_skill_points = open_bsc_skill_points
            elif open_adv_skill_points != 0:
                load_skill_points = open_adv_skill_points
            elif open_ext_skill_points != 0:
                load_skill_points = open_ext_skill_points

            flags = [0,0,0,0]
            flags[2] = flags[2] | bsc_clear << 1
            flags[2] = flags[2] | adv_clear << 2
            flags[2] = flags[2] | ext_clear << 3
            flags[2] = flags[2] | bass_bsc_clear << 4
            flags[2] = flags[2] | bass_adv_clear << 5
            flags[2] = flags[2] | bass_ext_clear << 6
            flags[2] = flags[2] | open_bsc_clear << 7
            flags[2] = flags[2] | open_adv_clear << 8
            flags[2] = flags[2] | open_ext_clear << 9
            flags[0] = flags[0] | bsc_fullcombo << 1
            flags[0] = flags[0] | adv_fullcombo << 2
            flags[0] = flags[0] | ext_fullcombo << 3
            flags[0] = flags[0] | bass_bsc_fullcombo << 4
            flags[0] = flags[0] | bass_adv_fullcombo << 5
            flags[0] = flags[0] | bass_ext_fullcombo << 6
            flags[0] = flags[0] | open_bsc_fullcombo << 7
            flags[0] = flags[0] | open_adv_fullcombo << 8
            flags[0] = flags[0] | open_ext_fullcombo << 9
            flags[1] = flags[1] | bsc_excellent << 1
            flags[1] = flags[1] | adv_excellent << 2
            flags[1] = flags[1] | ext_excellent << 3
            flags[1] = flags[1] | bass_bsc_excellent << 4
            flags[1] = flags[1] | bass_adv_excellent << 5
            flags[1] = flags[1] | bass_ext_excellent << 6
            flags[1] = flags[1] | open_bsc_excellent << 7
            flags[1] = flags[1] | open_adv_excellent << 8
            flags[1] = flags[1] | open_ext_excellent << 9

            musicdata = Node.void('musicdata')
            standard.add_child(musicdata)
            musicdata.set_attribute('musicid', str(key))

            musicdata.add_child(Node.s16_array('mdata', [cleared, -1, bsc_skill_perc, adv_skill_perc, ext_skill_perc, bass_bsc_skill_perc, bass_adv_skill_perc, bass_ext_skill_perc, open_bsc_skill_perc, open_adv_skill_perc, open_ext_skill_perc, bsc_result_rank, adv_result_rank, ext_result_rank, bass_bsc_result_rank, bass_adv_result_rank, bass_ext_result_rank, open_bsc_result_rank, open_adv_result_rank, open_ext_result_rank,]))
