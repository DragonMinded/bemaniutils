...
class GitadoraHighVoltage(
    ...
    def handle_highvoltage_gameinfo_request(self, request: Node) -> Node:
    ...
    def handle_highvoltage_playablemusic_request(self, request: Node) -> Node:
        ...
        secret_music = [605,611,712,718,751,900,938,1108,1221,1463,2660,2671,2672,2673,2674,2675,2676,2677,2681,2682,2683,2685,2687,2688,2689,2690,2691,2692,2693,2694,2696,2782,2812,2815,2816,2817,2818,2819]
        ...
        for song in all_songs:
            ...
            if song.chart == 14:
                ...
                if song.id in secret_music or 2700<= song.id <=2774 or 2784 <= song.id <= 2798: # hot music
    ...
    def format_profile(self, userid: UserID, profile: Profile) -> Node:
        ...
        '''
        sticker_list = [
            {"sticker_id": 1556,"sticker_pos_x":160.000000,"sticker_pos_y":277.000000,"sticker_scale_x":1.000000,"sticker_scale_y":1.000000,"sticker_rotate":0.000000},
        ]
        ...
        skindata.add_child(Node.u32_array('skin',profile.get_int_array('skin', 100, [255] * 100)))
    ...
    def unformat_profile(self, userid: UserID, request: Node, oldprofile: Profile) -> Profile:
        ...
        if skilldata is not None:
            ...
            if self.model.spec == 'A': #gf
                ...
                skilldata_dict.replace_int_array('gf_exist',25,skilldata.child_value('exist'))
                skilldata_dict.replace_int_array('gf_new',25,skilldata.child_value('new'))
            if self.model.spec == 'B': #dm
                ...
                skilldata_dict.replace_int_array('dm_exist',25,skilldata.child_value('exist'))
                skilldata_dict.replace_int_array('dm_new',25,skilldata.child_value('new'))
