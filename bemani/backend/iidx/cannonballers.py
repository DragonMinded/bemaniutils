    ...
    def unformat_profile(
        ...
        if onemore_data is not None:
            ...
            for i in range(3):
                i = i + 1
                omes_dict.replace_int(
                    f"challenge_num_{i}_n",
                    int(onemore_data.attribute(f"challenge_num_{i}_n")),
                )
                omes_dict.replace_int(
                    f"challenge_num_{i}_h",
                    int(onemore_data.attribute(f"challenge_num_{i}_h")),
                )
                omes_dict.replace_int(
                    f"challenge_num_{i}_a",
                    int(onemore_data.attribute(f"challenge_num_{i}_a")),
                )
