...
class IIDXBistrover(IIDXCourse, IIDXBase):
    ...
    GAME_CHART_TYPE_B14: Final[
        int
    ] = 5  # THere are no B14 charts in the game but this would be the id if there were
    ...
    def handle_IIDX28grade_raised_request(self, request: Node) -> Node:
        ...
        if eisei_data is not None:
            if userid is not None:
                ...
                eisei_dict.replace_int(
                    "clear_type", int(eisei_data.attribute("clear_type"))
                )
                eisei_dict.replace_int(
                    "grade_id", int(eisei_data.attribute("grade_id"))
                )
                eisei_dict.replace_int(
                    "grade_type", int(eisei_data.attribute("grade_type"))
                )
                eisei_dict.replace_int(
                    "stage_num", int(eisei_data.attribute("stage_num"))
                )
                eisei_dict.replace_int_array(
                    "past_achievement", 5, eisei_data.child_value("past_achievement")
                )
                eisei_dict.replace_int_array(
                    "past_selected_course",
                    5,
                    eisei_data.child_value("past_selected_course"),
                )
                eisei_dict.replace_int_array(
                    "max_past_achievement",
                    5,
                    eisei_data.child_value("max_past_achievement"),
                )
                eisei_dict.replace_int_array(
                    "max_past_selected_course",
                    5,
                    eisei_data.child_value("max_past_selected_course"),
                )
    ...
    def handle_IIDX28pc_common_request(self, request: Node) -> Node:
        ...
        extra_boss_event = Node.void(
            "extra_boss_event"
        )  # Always enable BISTRO LANDING Location 6
    ...
    def handle_IIDX28pc_shopregister_request(
        self, request: Node
    ...
    def format_profile(self, userid: UserID, profile: Profile) -> Node:
        ...
        lightning_setting.set_attribute(
            "headphone_vol", str(lightning_set_dict.get_int("headphone_vol"))
        )
        lightning_setting.set_attribute(
            "resistance_dp_left", str(lightning_set_dict.get_int("resistance_dp_left"))
        )
        lightning_setting.set_attribute(
            "resistance_dp_right",
            str(lightning_set_dict.get_int("resistance_dp_right")),
        )
        lightning_setting.set_attribute(
            "resistance_sp_left", str(lightning_set_dict.get_int("resistance_sp_left"))
        )
        lightning_setting.set_attribute(
            "resistance_sp_right",
            str(lightning_set_dict.get_int("resistance_sp_right")),
        )
        lightning_setting.set_attribute(
            "skin_0", str(lightning_set_dict.get_int("skin_0"))
        )
        lightning_setting.set_attribute(
            "flg_skin_0", str(lightning_set_dict.get_int("flg_skin_0"))
        )
        lightning_setting.add_child(
            Node.s32_array("slider", lightning_set_dict.get_int_array("slider", 7))
        )
        lightning_setting.add_child(
            Node.bool_array("light", lightning_set_dict.get_bool_array("light", 6))
        )
        lightning_setting.add_child(
            Node.bool("concentration", lightning_set_dict.get_bool("concentration"))
        )
        ...
        lightning_play_data.set_attribute(
            "spnum", str(lightning_play_dict.get_int("spnum"))
        )
        lightning_play_data.set_attribute(
            "dpnum", str(lightning_play_dict.get_int("dpnum"))
        )
        # Eisei Grade loading
        ...
        detail.add_child(
            Node.s32_array("past", eisei_data_dict.get_int_array("past_achievement", 5))
        )
        detail.add_child(
            Node.s32_array(
                "max_past", eisei_data_dict.get_int_array("max_past_achievement", 5)
            )
        )
        detail.add_child(
            Node.s32_array(
                "selected_course",
                eisei_data_dict.get_int_array("past_selected_course", 5),
            )
        )
        detail.add_child(
            Node.s32_array(
                "max_selected_course",
                eisei_data_dict.get_int_array("max_past_selected_course", 5),
            )
        )
        ...
        for notes_radar in achievements:
            ...
            notes_radar_node.add_child(
                Node.s32_array(
                    "radar_score", notes_radar.data.get_int_array("radar_score", 6)
                )
            )
        ...
        event1.set_attribute(
            "last_select_area_id", str(event1_dict.get_int("last_select_area"))
        )
        ...
        for area_data in achievements:
            ...
            area_data_node.set_attribute(
                "play_num", str(area_data.data.get_int("play_num"))
            )
            area_data_node.set_attribute(
                "area_prog", str(area_data.data.get_int("area_prog"))
            )
            area_data_node.set_attribute(
                "last_select_recipe", str(area_data.data.get_int("last_select_recipe"))
            )
            area_data_node.set_attribute(
                "operation_num", str(area_data.data.get_int("operation_num"))
            )
            area_data_node.set_attribute(
                "operation_prog", str(area_data.data.get_int("operation_prog"))
            )
            area_data_node.set_attribute(
                "recipe_prog0", str(area_data.data.get_int("recipe_prog0"))
            )
            area_data_node.set_attribute(
                "recipe_prog1", str(area_data.data.get_int("recipe_prog1"))
            )
            area_data_node.set_attribute(
                "recipe_prog2", str(area_data.data.get_int("recipe_prog2"))
            )
            area_data_node.set_attribute(
                "recipe_prog3", str(area_data.data.get_int("recipe_prog3"))
            )
            area_data_node.set_attribute(
                "recipe_prog4", str(area_data.data.get_int("recipe_prog4"))
            )
            area_data_node.add_child(
                Node.bool("is_complete", area_data.data.get_bool("is_complete"))
            )
        ...
        extra_boss_event.set_attribute(
            "key_orb", str(extra_boss_event_dict.get_int("key_orb"))
        )
        for i in range(8):
            extra_boss_event.set_attribute(
                f"boss_orb_{i}", str(extra_boss_event_dict.get_int(f"boss_orb_{i}"))
            )
    ...
    def unformat_profile(
        ...
        if lightning_setting is not None:
            ...
            lightning_set_dict.replace_int(
                "headphone_vol", int(lightning_setting.attribute("headphone_vol"))
            )
            lightning_set_dict.replace_int(
                "resistance_sp_left",
                int(lightning_setting.attribute("resistance_sp_left")),
            )
            lightning_set_dict.replace_int(
                "resistance_sp_right",
                int(lightning_setting.attribute("resistance_sp_right")),
            )
            lightning_set_dict.replace_int(
                "resistance_dp_left",
                int(lightning_setting.attribute("resistance_dp_left")),
            )
            lightning_set_dict.replace_int(
                "resistance_dp_right",
                int(lightning_setting.attribute("resistance_dp_right")),
            )
            ...
            lightning_set_dict.replace_int_array(
                "slider", 7, lightning_setting.child_value("slider")
            )
            lightning_set_dict.replace_bool_array(
                "light", 6, lightning_setting.child_value("light")
            )
            lightning_set_dict.replace_bool(
                "concentration", lightning_setting.child_value("concentration")
            )
        ...
        if extra_boss_event is not None:
            ...
            extra_boss_event_dict.replace_int(
                "key_orb", int(extra_boss_event.attribute("key_orb"))
            )
            for i in range(8):
                extra_boss_event_dict.replace_int(
                    f"boss_orb_{i}", int(extra_boss_event.attribute(f"boss_orb_{i}"))
                )
